...
export const zhCN = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "您无权访问此内容",
      forbiddenDescription: "该内容仅以只读方式共享，或您已不再拥有打开它的权限。",
    },
    accessibility: {
    ...
    contextSummary: {
      label: "上下文",
      empty: "上下文中未包含任何来源或笔记。",
      tokens: "{{value}} 个令牌",
      characters: "{{value}} 个字符",
    },
    clickToEdit: "点击编辑",
  },
  workbench: {
  ...
  apiErrors: {
    ...
    entraPermissionDenied: "Microsoft Graph 拒绝了请求。请租户管理员向已连接的应用授予所需权限并确认管理员同意 — 两者都需要。",
  ...
  groups: {
    ...
    syncEntra: "立即同步",
    syncedFromEntra: "已从 Entra 同步",
    linkedFromEntra: "从 Entra 关联",
    searchEntraGroups: "搜索 Entra 组",
    searchEntraPlaceholder: "输入以搜索你的 Entra 目录…",
    noEntraResults: "没有匹配的 Entra 组",
  ...
  notebooks: {
    title: "笔记本",
    description: "在专注的工作区中整理来源、笔记和研究。",
    newNotebook: "创建笔记本",
    searchPlaceholder: "搜索笔记本...",
    sortLabel: "笔记本排序",
    sortDirection: "更改排序方向",
    archived: "已归档",
    archive: "归档",
    unarchive: "取消归档",
    archiveConfirmTitle: "归档笔记本？",
    archiveConfirmDescription: "确定要归档“{{name}}”吗？之后可从已归档笔记本中恢复。",
    unarchiveConfirmTitle: "取消归档笔记本？",
    unarchiveConfirmDescription: "确定要将“{{name}}”移回活动笔记本吗？",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "文件上传区域",
    uploadDropzoneCta: "将文件拖到此处，或点击浏览",
    uploadRejectedFiles: "已跳过 {{count}} 个不支持的文件：{{files}}",
    selectedFiles: "已选择文件：",
    ...
    librarySearchLabel: "搜索来源",
    librarySearchPlaceholder: "搜索来源标题...",
    sortLabel: "来源排序",
    sortDirection: "更改排序方向",
    loadMore: "加载更多来源",
  ...
  searchPage: {
    ...
    askNeedsEmbedding: "提问需要嵌入模型",
    askNeedsEmbeddingDesc: "设置嵌入模型后，提问才能使用你的资料。",
    askNeedsChat: "提问需要聊天模型",
    askNeedsChatDesc: "提问前请先设置聊天模型。",
    advanced: "高级",
    strategy: "策略",
    answer: "回答",
    final: "最终",
    ...
    searchType: "搜索类型",
    vectorSearchOff: "向量搜索已关闭",
    vectorSearchOffDesc: "设置嵌入模型后即可按含义搜索。文本搜索仍然可用。",
    setUpModels: "设置模型",
    textSearch: "文本搜索",
    vectorSearch: "向量搜索",
    searchIn: "搜索范围",
  ...
  podcasts: {
    ...
    outlineTab: "大纲",
    transcriptTab: "脚本",
    commonDetailsTab: "通用详情",
    briefing: "内容简报",
    noOutline: "暂无大纲。",
    noTranscript: "暂无脚本。",
    episodeNotFound: "未找到剧集",
    episodeNotFoundDesc: "请求的剧集不存在。",
    backToPodcasts: "返回播客",
  ...
  advanced: {
    ...
    updateAvailableDesc: "{{appName}} 的新版本可用。",
    upToDate: "已是最新",
    unknown: "未知",
  ...
  transformations: {
    ...
    listTitle: "自定义转换",
    createNew: "新建转换",
    createTransformation: "创建转换",
    createSheetDescription: "创建可复用的提示词，将来源内容转换为摘要、洞察或结构化输出。",
    editSheetDescription: "更新控制来源内容转换方式的提示词、模型和默认设置。",
    inputLabel: "输入文本",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "配置用于 {{appName}} 不同用途的默认模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有这些模型，{{appName}} 可能无法正常运行。",
  ...
  apiKeys: {
    ...
    apiVersion: "API 版本",
    apiVersionHint: "Azure OpenAI 必填（例如 2024-10-21）。请使用你的 Azure 资源所支持的版本。",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "从 SharePoint 导入文档",
    unavailable: "SharePoint 连接器尚未配置。请联系管理员启用。",
    requestFailed: "SharePoint 请求失败，请重试。",
    connect: "连接 SharePoint",
    connectDescription: "连接 Microsoft 帐户以浏览 SharePoint 文档。",
    empty: "此处未找到内容。",
    folderHint: "将导入此文件夹及其中受支持的文档。",
    importFolder: "导入此文件夹",
    location: "SharePoint 位置",
    partial: "部分完成",
    pending: "待处理",
    processingHint: "此批次完成后，导入的文档可能仍在处理中。",
    progress: "已完成 {{completed}}/{{total}}；失败 {{failed}}",
    queued: "已排队",
    searchSites: "搜索站点",
    selectAll: "选择本页所有受支持的文件",
    ...
    connectionsDescription: "连接用于导入文档的帐户。",
    cardDescription: "导入您可以阅读的文档副本。SharePoint 中的文件不会更改。",
    connected: "已连接",
    notConnected: "未连接",
    needsReconnect: "需要重新连接",
    manageConnection: "管理连接",
    disconnectMicrosoft: "在你于“我的应用”中移除之前，Microsoft 可能仍会列出此应用。",
