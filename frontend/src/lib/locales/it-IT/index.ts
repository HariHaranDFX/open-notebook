...
export const itIT = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "Non hai accesso a questo contenuto",
      forbiddenDescription: "È condiviso in sola lettura, oppure non hai più il permesso di aprirlo.",
    },
    accessibility: {
      ...
      settingsNav: "Navigazione impostazioni",
    },
    url: "URL",
    ...
    contextModes: {
      ...
      full: "Fonte completa",
      included: "Incluso",
      sourceLabel: "Contesto della fonte",
      noteLabel: "Contesto della nota",
    },
    contextSummary: {
      label: "Contesto",
      empty: "Nessuna fonte o nota è inclusa nel contesto.",
      tokens: "{{value}} token",
      characters: "{{value}} caratteri",
    },
  ...
  apiErrors: {
    ...
    entraPermissionDenied: "Microsoft Graph ha rifiutato la richiesta. Chiedi all'amministratore del tenant di concedere all'app connessa l'autorizzazione richiesta e di confermare il consenso amministratore — entrambi sono necessari.",
  ...
  connectionErrors: {
    ...
    apiDesc: "Il server API di {{appName}} non è raggiungibile",
  ...
  sharing: {
    share: "Condividi",
    title: "Condividi",
    description: "Gestisci chi può accedere",
    grants: "Persone con accesso",
    noGrants: "Non ancora condiviso",
    add: "Aggiungi",
    user: "Utente",
    group: "Gruppo",
  ...
  groups: {
    ...
    syncedFromEntra: "Sincronizzato da Entra",
    linkedFromEntra: "Collegato da Entra",
    searchEntraGroups: "Cerca gruppi Entra",
    searchEntraPlaceholder: "Digita per cercare nella tua directory Entra…",
    noEntraResults: "Nessun gruppo Entra corrispondente",
  ...
  notebooks: {
    title: "Quaderni",
    description: "Organizza fonti, note e ricerche in spazi di lavoro mirati.",
    newNotebook: "Nuovo quaderno",
    searchPlaceholder: "Cerca quaderni...",
    sortLabel: "Ordina quaderni",
    sortDirection: "Cambia direzione di ordinamento",
    archived: "Archiviati",
    archive: "Archivia",
    unarchive: "Ripristina",
    archiveConfirmTitle: "Archiviare il quaderno?",
    archiveConfirmDescription: "Vuoi davvero archiviare \"{{name}}\"? Potrai ripristinarlo in seguito dai quaderni archiviati.",
    unarchiveConfirmTitle: "Ripristinare il quaderno?",
    unarchiveConfirmDescription: "Vuoi davvero spostare \"{{name}}\" di nuovo nei quaderni attivi?",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "Area di caricamento file",
    uploadDropzoneCta: "Trascina qui i file, o fai clic per sfogliare",
    uploadRejectedFiles: "{{count}} file non supportati ignorati: {{files}}",
    ...
    librarySearchLabel: "Cerca fonti",
    librarySearchPlaceholder: "Cerca nei titoli...",
    sortLabel: "Ordina fonti",
    sortDirection: "Cambia direzione di ordinamento",
    loadMore: "Carica altre fonti",
    ...
    statusPartial: "Parzialmente disponibile",
  ...
  searchPage: {
    askAndSearch: "Chiedi e cerca",
    askAndSearchDesc: "Poni domande o cerca nella tua base di conoscenza.",
    askBeta: "Chiedi (beta)",
    search: "Cerca",
    ...
    askNeedsEmbedding: "Ask richiede un modello di embedding",
    askNeedsEmbeddingDesc: "Imposta un modello di embedding così Ask può usare le tue fonti.",
    askNeedsChat: "Ask richiede un modello di chat",
    askNeedsChatDesc: "Imposta un modello di chat prima di fare una domanda.",
    advanced: "Avanzate",
    strategy: "Strategia",
    answer: "Risposta",
    final: "Finale",
    ...
    vectorSearchOff: "La ricerca vettoriale è disattivata",
    vectorSearchOffDesc: "Imposta un modello di embedding per cercare per significato. La ricerca testuale resta disponibile.",
    setUpModels: "Configura i modelli",
  ...
  advanced: {
    ...
    updateAvailableDesc: "È disponibile una nuova versione di {{appName}}.",
    upToDate: "Aggiornato",
    unknown: "Sconosciuto",
  ...
  transformations: {
    ...
    createTransformation: "Crea trasformazione",
    createSheetDescription: "Crea un prompt riutilizzabile che trasformi il contenuto della fonte in riepiloghi, approfondimenti o output strutturati.",
    editSheetDescription: "Aggiorna il prompt, il modello e le impostazioni predefinite che controllano la trasformazione del contenuto della fonte.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configura quali modelli usare per diversi scopi in {{appName}}",
    missingRequiredModels: "Modelli richiesti mancanti: {{models}}. {{appName}} potrebbe non funzionare correttamente senza questi.",
  ...
  apiKeys: {
    ...
    apiVersionHint: "Obbligatoria per Azure OpenAI (es. 2024-10-21). Usa la versione supportata dalla tua risorsa Azure.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Importa documenti da SharePoint",
    unavailable: "Il connettore SharePoint non è configurato. Chiedi a un amministratore di abilitarlo.",
    requestFailed: "La richiesta a SharePoint non è riuscita. Riprova.",
    connect: "Connetti SharePoint",
    connectDescription: "Connetti il tuo account Microsoft per sfogliare i documenti SharePoint.",
    empty: "Nessun elemento trovato qui.",
    folderHint: "Questa cartella e i documenti supportati verranno importati.",
    importFolder: "Importa questa cartella",
    location: "Percorso SharePoint",
    partial: "Completato parzialmente",
    pending: "In attesa",
    processingHint: "I documenti importati potrebbero essere ancora in elaborazione al termine del batch.",
    progress: "{{completed}} di {{total}} completati; {{failed}} non riusciti",
    queued: "In coda",
    searchSites: "Cerca siti",
    selectAll: "Seleziona tutti i file supportati in questa pagina",
    ...
    connectionsDescription: "Collega gli account usati per importare i documenti.",
    cardDescription: "Importa copie dei documenti che puoi leggere. I file in SharePoint restano invariati.",
    connected: "Connesso",
    notConnected: "Non connesso",
    needsReconnect: "Riconnessione necessaria",
    manageConnection: "Gestisci connessione",
    disconnectMicrosoft: "Microsoft puo continuare a elencare questa app finche non la rimuovi in Le mie app.",
