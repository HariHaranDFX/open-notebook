...
3. **Update regularly** — Pull latest image: `docker pull haribabudfx/open-notebook-commercial:latest`
...
- **Ask for help:** [Discord](https://discord.gg/37XJPXfz2w) or [GitHub Issues](https://github.com/HariHaranDFX/open-notebook/issues)
