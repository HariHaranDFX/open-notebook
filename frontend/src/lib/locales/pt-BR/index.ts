...
export const ptBR = {
  ...
  settings: {
    ...
    filesHelp: "Uma vez que seus arquivos são enviados e processados, eles não são mais necessários. A maioria dos usuários deve permitir que {{appName}} exclua arquivos enviados da pasta de upload automaticamente.",
