...
_PROVIDER_SPECS: Tuple[ProviderSpec, ...] = (
        ...
        ProviderSpec(
            ...
            docs_url="https://github.com/HariHaranDFX/open-notebook/blob/main/docs/5-CONFIGURATION/omlx.md",
        ...
        ProviderSpec(
            ...
            test_model=None,  # Dynamic - uses first available model
            docs_url="https://github.com/HariHaranDFX/open-notebook/blob/main/docs/5-CONFIGURATION/openai-compatible.md",
        ),
        ProviderSpec(
            ...
            docs_url="https://github.com/HariHaranDFX/open-notebook/blob/main/docs/5-CONFIGURATION/ai-providers.md",
