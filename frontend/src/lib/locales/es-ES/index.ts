...
export const esES = {
  ...
  settings: {
    ...
    filesHelp: "Una vez que tus archivos se suben y procesan, ya no son necesarios. La mayoría de los usuarios deberían permitir que {{appName}} elimine los archivos subidos de la carpeta de carga automáticamente.",
