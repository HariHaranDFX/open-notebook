    ...
    async def get_model(self, model_id: str, **kwargs) -> Optional[ModelType]:
        ...
        if model.credential:
            ...
            if credential:
                ...
                # anthropic_compatible endpoints defer URL revalidation to
                # resolve_anthropic_compatible_config below (which applies
                # base-URL normalization first). Revalidating raw here would
                # reject valid Messages-only endpoints (upstream #1350).
