...
export const ruRU = {
  ...
  settings: {
    ...
    originalFilePolicyDesc: "How uploaded original files are retained after processing. Applies to new uploads only.",
    ...
    allowOwnerCleanupDesc: "When enabled, source owners can delete their own retained originals. Never grants deletion rights to editors or viewers.",
