...
export const itIT = {
  ...
  settings: {
    ...
    filesHelp: "Una volta caricati ed elaborati, i tuoi file non sono più necessari. La maggior parte degli utenti dovrebbe permettere a {{appName}} di eliminare automaticamente i file caricati dalla cartella upload.",
