...
export const esES = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "No tienes acceso a este contenido",
      forbiddenDescription: "Se comparte solo como lectura, o ya no tienes permiso para abrirlo.",
    },
    accessibility: {
      ...
      settingsNav: "Navegación de ajustes",
    },
    url: "URL",
    ...
    contextModes: {
      ...
      full: "Fuente completa",
      included: "Incluido",
      sourceLabel: "Contexto de la fuente",
      noteLabel: "Contexto de la nota",
    },
    contextSummary: {
      label: "Contexto",
      empty: "No hay fuentes ni notas incluidas en el contexto.",
      tokens: "{{value}} tokens",
  ...
  apiErrors: {
    ...
    entraPermissionDenied: "Microsoft Graph rechazó la solicitud. Pide al administrador del tenant que otorgue a la aplicación conectada el permiso necesario y confirme el consentimiento del administrador — ambos son obligatorios.",
  ...
  connectionErrors: {
    ...
    apiDesc: "No se pudo alcanzar el servidor API de {{appName}}",
  ...
  sharing: {
    share: "Compartir",
    title: "Compartir",
    description: "Gestionar quién puede acceder",
    grants: "Personas con acceso",
    noGrants: "Aún no compartido",
    add: "Añadir",
    user: "Usuario",
    group: "Grupo",
    viewer: "Lector",
  ...
  groups: {
    ...
    syncedFromEntra: "Sincronizado desde Entra",
    linkedFromEntra: "Vinculado desde Entra",
    searchEntraGroups: "Buscar grupos de Entra",
    searchEntraPlaceholder: "Escribe para buscar en tu directorio de Entra…",
    noEntraResults: "No hay grupos de Entra coincidentes",
  ...
  notebooks: {
    title: "Cuadernos",
    description: "Organiza fuentes, notas e investigaciones en espacios de trabajo enfocados.",
    newNotebook: "Nuevo cuaderno",
    searchPlaceholder: "Buscar cuadernos...",
    sortLabel: "Ordenar cuadernos",
    sortDirection: "Cambiar dirección de ordenación",
    archived: "Archivado",
    archive: "Archivar",
    unarchive: "Desarchivar",
    archiveConfirmTitle: "¿Archivar el cuaderno?",
    archiveConfirmDescription: "¿Seguro que quieres archivar «{{name}}»? Puedes restaurarlo más tarde desde Cuadernos archivados.",
    unarchiveConfirmTitle: "¿Desarchivar el cuaderno?",
    unarchiveConfirmDescription: "¿Seguro que quieres devolver «{{name}}» a Cuadernos activos?",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "Área de carga de archivos",
    uploadDropzoneCta: "Arrastra archivos aquí, o haz clic para examinar",
    uploadRejectedFiles: "Se omitieron {{count}} archivo(s) no admitido(s): {{files}}",
    ...
    librarySearchLabel: "Buscar fuentes",
    librarySearchPlaceholder: "Buscar títulos de fuentes...",
    sortLabel: "Ordenar fuentes",
    sortDirection: "Cambiar dirección de ordenación",
    loadMore: "Cargar más fuentes",
    ...
    statusPartial: "Disponible parcialmente",
  ...
  searchPage: {
    askAndSearch: "Preguntar y buscar",
    askAndSearchDesc: "Haz preguntas o busca en tu base de conocimiento.",
    ...
    askNeedsEmbedding: "Ask necesita un modelo de embedding",
    askNeedsEmbeddingDesc: "Configura un modelo de embedding para que Ask use tus fuentes.",
    askNeedsChat: "Ask necesita un modelo de chat",
    askNeedsChatDesc: "Configura un modelo de chat antes de hacer una pregunta.",
    advanced: "Avanzado",
    strategy: "Estrategia",
    answer: "Respuesta",
    final: "Final",
    ...
    vectorSearchOff: "La búsqueda vectorial está desactivada",
    vectorSearchOffDesc: "Configura un modelo de embedding para buscar por significado. La búsqueda de texto sigue disponible.",
  ...
  podcasts: {
    ...
    commonDetailsTab: "Detalles generales",
    briefing: "Briefing",
    noOutline: "No hay esquema disponible.",
    noTranscript: "No hay transcripción disponible.",
    episodeNotFound: "Episodio no encontrado",
    episodeNotFoundDesc: "El episodio solicitado no existe.",
    backToPodcasts: "Volver a los podcasts",
  ...
  settings: {
    ...
    originalFilePolicy: "Política de archivos originales",
    ...
    originalFilePolicyAlwaysKeep: "Conservar siempre",
    originalFilePolicyUserChoice: "Dejar elegir al usuario",
    originalFilePolicyAlwaysDelete: "Eliminar siempre tras el procesamiento",
    originalFileDefault: "Acción por defecto en cargas",
    originalFileDefaultDesc: "Se usa cuando el propietario no elige.",
    originalFileDefaultKeep: "Conservar original",
    originalFileDefaultDelete: "Eliminar tras el procesamiento",
    allowOwnerCleanup: "Permitir a propietarios limpiar sus archivos",
    ...
    fileRetentionFuture: "Los cambios de política solo afectan a futuras cargas; las fuentes existentes no se modifican.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Una nueva versión de {{appName}} está disponible.",
  ...
  transformations: {
    ...
    createTransformation: "Crear transformación",
    createSheetDescription: "Crea un prompt reutilizable que convierta el contenido de la fuente en resúmenes, ideas o resultados estructurados.",
    editSheetDescription: "Actualiza el prompt, el modelo y los valores predeterminados que controlan cómo se transforma el contenido de la fuente.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Importar documentos desde SharePoint",
    unavailable: "El conector de SharePoint no está configurado. Pide a un administrador que lo habilite.",
    requestFailed: "La solicitud a SharePoint falló. Inténtalo de nuevo.",
    connect: "Conectar SharePoint",
    connectDescription: "Conecta tu cuenta de Microsoft para explorar documentos de SharePoint.",
    empty: "No se encontró nada aquí.",
    folderHint: "Se importarán esta carpeta y los documentos compatibles que contiene.",
    importFolder: "Importar esta carpeta",
    location: "Ubicación de SharePoint",
    partial: "Completado parcialmente",
    pending: "Pendiente",
    processingHint: "Es posible que los documentos importados sigan procesándose después de que finalice este lote.",
    progress: "{{completed}} de {{total}} completados; {{failed}} fallidos",
    queued: "En cola",
    searchSites: "Buscar sitios",
    selectAll: "Seleccionar todos los archivos compatibles de esta página",
    ...
    connectionsDescription: "Conecte las cuentas usadas para importar documentos.",
    cardDescription: "Importe copias de los documentos que puede leer. Los archivos en SharePoint no cambian.",
    connected: "Conectado",
    notConnected: "No conectado",
    needsReconnect: "Necesita reconexion",
    manageConnection: "Administrar conexion",
    disconnectMicrosoft: "Microsoft puede seguir mostrando esta aplicacion hasta que la quite en Mis aplicaciones.",
