...
- [x] **Step 4: Verify detail behavior**
...
- [x] **Step 2: Replace local view state with URL state**
...
- [x] **Step 3: Keep profile cards bounded and useful**
...
- [x] **Step 1: Write failing URL/playground tests**
...
- [x] **Step 2: Replace local tab/selection state**
...
- [x] **Step 3: Make transformation rows explicit**
