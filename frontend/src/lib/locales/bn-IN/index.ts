...
export const bnIN = {
  ...
  apiErrors: {
    ...
    entraPermissionDenied: "Microsoft Graph অনুরোধটি প্রত্যাখ্যান করেছে। টেন্যান্ট প্রশাসককে Open Notebook-কে প্রয়োজনীয় অনুমতি প্রদান করতে এবং অ্যাডমিন সম্মতি নিশ্চিত করতে বলুন — উভয়ই প্রয়োজন।",
