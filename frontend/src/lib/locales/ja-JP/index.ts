...
export const jaJP = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "このコンテンツへのアクセス権がありません",
      forbiddenDescription: "閲覧のみで共有されているか、開く権限がなくなっています。",
    },
    accessibility: {
    ...
    contextModes: {
      ...
      full: "ソース全文",
      included: "含める",
      sourceLabel: "ソースのコンテキスト",
      noteLabel: "ノートのコンテキスト",
    },
    contextSummary: {
      label: "コンテキスト",
      empty: "コンテキストにソースまたはノートが含まれていません。",
      tokens: "{{value}}トークン",
      characters: "{{value}}文字",
    },
  ...
  connectionErrors: {
    ...
    apiDesc: "{{appName}} APIサーバーに到達できませんでした",
  ...
  sharing: {
    share: "共有",
    title: "共有",
    description: "アクセス権限を管理",
    grants: "アクセス可能なユーザー",
    noGrants: "まだ共有されていません",
    add: "追加",
    user: "ユーザー",
    group: "グループ",
    viewer: "閲覧者",
  ...
  groups: {
    ...
    syncEntra: "今すぐ同期",
    syncedFromEntra: "Entra から同期済み",
    linkedFromEntra: "Entra からリンク済み",
    searchEntraGroups: "Entra グループを検索",
    searchEntraPlaceholder: "Entra ディレクトリを検索するには入力してください…",
    noEntraResults: "一致する Entra グループがありません",
  ...
  notebooks: {
    title: "ノートブック",
    description: "ソース、ノート、調査を目的別のワークスペースに整理します。",
    newNotebook: "新規ノートブック",
    searchPlaceholder: "ノートブックを検索...",
    sortLabel: "ノートブックを並べ替え",
    sortDirection: "並べ替え方向を変更",
    archived: "アーカイブ済み",
    archive: "アーカイブ",
    unarchive: "アーカイブ解除",
    archiveConfirmTitle: "ノートブックをアーカイブしますか？",
    archiveConfirmDescription: "「{{name}}」をアーカイブしますか？後でアーカイブ済みノートブックから復元できます。",
    unarchiveConfirmTitle: "ノートブックのアーカイブを解除しますか？",
    unarchiveConfirmDescription: "「{{name}}」をアクティブなノートブックに戻しますか？",
  ...
  sources: {
    ...
    selectMultipleFilesHint: "複数ファイルを選択して一括インポート。対応ドキュメント：PDF、DOC、DOCX、PPT、XLS、EPUB、TXT、MD。",
    mediaUnavailable: "音声・動画のアップロードは利用できません — サーバーに FFmpeg がインストールされていません。",
    imagesUnavailable: "画像の抽出は利用できません — サーバーに Docling がインストールされていません。",
    uploadDropzoneLabel: "ファイルアップロード領域",
    uploadDropzoneCta: "ファイルをここにドラッグするか、クリックして参照します",
    uploadRejectedFiles: "サポートされていないファイル {{count}} 件をスキップしました：{{files}}",
    ...
    librarySearchLabel: "ソースを検索",
    librarySearchPlaceholder: "ソースのタイトルを検索...",
    sortLabel: "ソースを並べ替え",
    sortDirection: "並べ替え方向を変更",
    loadMore: "さらにソースを読み込む",
  ...
  searchPage: {
    askAndSearch: "質問と検索",
    askAndSearchDesc: "質問するか、ナレッジベースを検索します。",
    askBeta: "質問（ベータ）",
    search: "検索",
    ...
    askNeedsEmbedding: "Ask には埋め込みモデルが必要です",
    askNeedsEmbeddingDesc: "Ask が資料を使えるように埋め込みモデルを設定してください。",
    askNeedsChat: "Ask にはチャットモデルが必要です",
    askNeedsChatDesc: "質問する前にチャットモデルを設定してください。",
    advanced: "詳細設定",
    strategy: "戦略",
    answer: "回答",
    final: "最終",
    ...
    searchType: "検索タイプ",
    vectorSearchOff: "ベクトル検索はオフです",
    vectorSearchOffDesc: "意味で検索するには埋め込みモデルを設定してください。テキスト検索はそのまま使えます。",
    setUpModels: "モデルを設定",
    textSearch: "テキスト検索",
    vectorSearch: "ベクトル検索",
    searchIn: "検索対象",
  ...
  advanced: {
    ...
    updateAvailableDesc: "{{appName}}の新しいバージョンが利用可能です。",
    upToDate: "最新版です",
    unknown: "不明",
  ...
  transformations: {
    ...
    listTitle: "カスタム変換",
    createNew: "新規作成",
    createTransformation: "変換を作成",
    createSheetDescription: "ソースの内容を要約、洞察、または構造化された出力に変換する再利用可能なプロンプトを作成します。",
    editSheetDescription: "ソースの内容の変換方法を制御するプロンプト、モデル、デフォルト設定を更新します。",
    inputLabel: "入力テキスト",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "{{appName}}全体で異なる目的に使用するモデルを設定",
    missingRequiredModels: "必須モデルがありません: {{models}}。これらがないと{{appName}}が正しく機能しない可能性があります。",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "SharePoint から文書をインポート",
    unavailable: "SharePoint コネクターが設定されていません。管理者に有効化を依頼してください。",
    requestFailed: "SharePoint へのリクエストに失敗しました。もう一度お試しください。",
    connect: "SharePoint に接続",
    connectDescription: "Microsoft アカウントを接続して SharePoint の文書を参照します。",
    empty: "ここには何も見つかりませんでした。",
    folderHint: "このフォルダーと対応している文書がインポートされます。",
    importFolder: "このフォルダーをインポート",
    location: "SharePoint の場所",
    partial: "一部完了",
    pending: "保留中",
    processingHint: "このバッチが完了した後も、インポートした文書の処理が続く場合があります。",
    progress: "{{total}} 件中 {{completed}} 件完了、{{failed}} 件失敗",
    queued: "待機中",
    searchSites: "サイトを検索",
    selectAll: "このページの対応ファイルをすべて選択",
    selected: "{{count}} 件のファイルを選択中",
    sites: "サイト",
    skipped: "スキップ",
    ...
    connectionsDescription: "文書の取り込みに使うアカウントを接続します。",
    cardDescription: "読める文書のコピーを取り込みます。SharePoint のファイルは変更されません。",
    connected: "接続済み",
    notConnected: "未接続",
    needsReconnect: "再接続が必要",
    manageConnection: "接続を管理",
    disconnectMicrosoft: "マイ アプリで削除するまで、Microsoft はこのアプリを一覧に表示し続ける場合があります。",
