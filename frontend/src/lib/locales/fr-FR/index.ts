...
export const frFR = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "Vous n'avez pas accès à ce contenu",
      forbiddenDescription: "Il est partagé en lecture seule, ou vous n'avez plus la permission de l'ouvrir.",
    },
    accessibility: {
    ...
    contextModes: {
      ...
      full: "Source complète",
      included: "Inclus",
      sourceLabel: "Contexte de la source",
      noteLabel: "Contexte de la note",
    },
    contextSummary: {
      label: "Contexte",
      empty: "Aucune source ou note n’est incluse dans le contexte.",
      tokens: "{{value}} jetons",
      characters: "{{value}} caractères",
    },
  ...
  connectionErrors: {
    ...
    apiDesc: "Le serveur API de {{appName}} est injoignable",
  ...
  sharing: {
    ...
    grants: "Personnes avec accès",
    noGrants: "Pas encore partagé",
    add: "Ajouter",
    user: "Utilisateur",
    group: "Groupe",
    viewer: "Lecteur",
  ...
  groups: {
    ...
    syncedFromEntra: "Synchronisé depuis Entra",
    linkedFromEntra: "Lié depuis Entra",
    searchEntraGroups: "Rechercher des groupes Entra",
    searchEntraPlaceholder: "Tapez pour rechercher dans votre annuaire Entra…",
    noEntraResults: "Aucun groupe Entra correspondant",
  ...
  notebooks: {
    title: "Carnets",
    description: "Organisez les sources, les notes et les recherches dans des espaces de travail ciblés.",
    newNotebook: "Nouveau Carnet",
    searchPlaceholder: "Rechercher des carnets...",
    sortLabel: "Trier les carnets",
    sortDirection: "Changer le sens du tri",
    archived: "Archivé",
    archive: "Archiver",
    unarchive: "Désarchiver",
    archiveConfirmTitle: "Archiver le carnet ?",
    archiveConfirmDescription: "Voulez-vous vraiment archiver « {{name}} » ? Vous pourrez le restaurer plus tard depuis les carnets archivés.",
    unarchiveConfirmTitle: "Désarchiver le carnet ?",
    unarchiveConfirmDescription: "Voulez-vous vraiment replacer « {{name}} » dans les carnets actifs ?",
  ...
  sources: {
    ...
    selectMultipleFilesHint: "Sélectionnez plusieurs fichiers pour une importation groupée. Documents pris en charge : PDF, DOC, DOCX, PPT, XLS, EPUB, TXT, MD.",
    mediaUnavailable: "Le téléversement audio et vidéo n'est pas disponible : FFmpeg n'est pas installé sur le serveur.",
    imagesUnavailable: "L'extraction d'images n'est pas disponible : Docling n'est pas installé sur le serveur.",
    uploadDropzoneLabel: "Zone de téléversement de fichiers",
    uploadDropzoneCta: "Faites glisser les fichiers ici, ou cliquez pour parcourir",
    uploadRejectedFiles: "{{count}} fichier(s) non pris en charge ignoré(s) : {{files}}",
    ...
    librarySearchLabel: "Rechercher des sources",
    librarySearchPlaceholder: "Rechercher dans les titres...",
    sortLabel: "Trier les sources",
    sortDirection: "Changer le sens du tri",
    loadMore: "Charger plus de sources",
    ...
    statusPartial: "Partiellement disponible",
  ...
  searchPage: {
    ...
    askAndSearchDesc: "Posez des questions ou recherchez dans votre base de connaissances.",
    ...
    askNeedsEmbedding: "Ask a besoin d'un modèle d'embedding",
    askNeedsEmbeddingDesc: "Définissez un modèle d'embedding pour qu'Ask utilise vos sources.",
    askNeedsChat: "Ask a besoin d'un modèle de chat",
    askNeedsChatDesc: "Définissez un modèle de chat avant de poser une question.",
    advanced: "Avancé",
    strategy: "Stratégie",
    answer: "Réponse",
    final: "Final",
    ...
    vectorSearchOff: "La recherche vectorielle est désactivée",
    vectorSearchOffDesc: "Définissez un modèle d'embedding pour chercher par le sens. La recherche textuelle reste disponible.",
    setUpModels: "Configurer les modèles",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Une nouvelle version de {{appName}} est disponible.",
    upToDate: "À jour",
    unknown: "Inconnu",
  ...
  transformations: {
    ...
    createSheetDescription: "Créez un prompt réutilisable qui transforme le contenu source en résumés, informations clés ou résultats structurés.",
    editSheetDescription: "Mettez à jour le prompt, le modèle et les paramètres par défaut qui contrôlent la transformation du contenu source.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configurez quels modèles utiliser pour les différents usages de {{appName}}",
    missingRequiredModels: "Modèles requis manquants : {{models}}. {{appName}} pourrait ne pas fonctionner correctement sans eux.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Importer des documents depuis SharePoint",
    unavailable: "Le connecteur SharePoint n'est pas configuré. Demandez à un administrateur de l'activer.",
    requestFailed: "La requête SharePoint a échoué. Réessayez.",
    connect: "Connecter SharePoint",
    connectDescription: "Connectez votre compte Microsoft pour parcourir les documents SharePoint.",
    empty: "Aucun élément trouvé ici.",
    folderHint: "Ce dossier et ses documents pris en charge seront importés.",
    importFolder: "Importer ce dossier",
    location: "Emplacement SharePoint",
    partial: "Partiellement terminé",
    pending: "En attente",
    processingHint: "Les documents importés peuvent encore être en cours de traitement après la fin de ce lot.",
    progress: "{{completed}} sur {{total}} terminés ; {{failed}} échecs",
    queued: "En file d'attente",
    searchSites: "Rechercher des sites",
    selectAll: "Sélectionner tous les fichiers pris en charge sur cette page",
    ...
    connectionsDescription: "Connectez les comptes utilises pour importer des documents.",
    cardDescription: "Importez des copies des documents que vous pouvez lire. Les fichiers dans SharePoint restent inchanges.",
    connected: "Connecte",
    notConnected: "Non connecte",
    needsReconnect: "Reconnexion requise",
    manageConnection: "Gerer la connexion",
    disconnectMicrosoft: "Microsoft peut continuer a lister cette application jusqu'a ce que vous la retiriez dans Mes applications.",
