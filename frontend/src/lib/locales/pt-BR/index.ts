...
export const ptBR = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "Você não tem acesso a este conteúdo",
      forbiddenDescription: "Ele é compartilhado apenas para leitura, ou você não tem mais permissão para abri-lo.",
    },
    accessibility: {
      ...
      settingsNav: "Navegação de configurações",
    },
    url: "URL",
    ...
    contextModes: {
      ...
      full: "Fonte completa",
      included: "Incluído",
      sourceLabel: "Contexto da fonte",
      noteLabel: "Contexto da nota",
    },
    contextSummary: {
      label: "Contexto",
      empty: "Nenhuma fonte ou nota está incluída no contexto.",
      tokens: "{{value}} tokens",
      characters: "{{value}} caracteres",
    },
  ...
  apiErrors: {
    ...
    transformationEditShared: "Only an administrator can edit shared transformations.",
    transformationEditOwn: "You can only edit your own transformations.",
    transformationDeleteShared: "Only an administrator can delete shared transformations.",
    transformationDeleteOwn: "You can only delete your own transformations.",
    transformationRestoreAdmin: "Only an administrator can restore built-in transformations.",
    ...
    entraGroupManaged: "Este grupo é gerenciado pela sincronização do Entra e não pode ser editado aqui.",
    entraCredentialInvalid: "As credenciais do aplicativo Entra conectado são inválidas ou expiraram. Peça a um operador para atualizá-las.",
    entraPermissionDenied: "O Microsoft Graph recusou a solicitação. Peça ao administrador do tenant para conceder ao aplicativo conectado a permissão necessária e confirmar o consentimento administrativo — ambos são necessários.",
    entraGraphUpstream: "O Microsoft Graph está inacessível ou retornou um erro. Tente novamente em breve.",
    entraSyncDisabled: "A sincronização de grupos do Entra não está habilitada nesta implantação. Peça a um operador para habilitá-la antes de executar uma sincronização manual.",
  },
  connectionErrors: {
    apiTitle: "Não foi possível conectar ao servidor da API",
    apiDesc: "Não foi possível acessar o servidor da API de {{appName}}",
  ...
  sharing: {
    share: "Compartilhar",
    title: "Compartilhar",
    description: "Gerenciar quem pode acessar",
    grants: "Pessoas com acesso",
    noGrants: "Ainda não compartilhado",
    add: "Adicionar",
    user: "Usuário",
    group: "Grupo",
    viewer: "Leitor",
  ...
  groups: {
    ...
    syncedFromEntra: "Sincronizado do Entra",
    linkedFromEntra: "Vinculado do Entra",
    searchEntraGroups: "Pesquisar grupos do Entra",
    searchEntraPlaceholder: "Digite para pesquisar no seu diretório Entra…",
    noEntraResults: "Nenhum grupo do Entra correspondente",
  ...
  notebooks: {
    title: "Cadernos",
    description: "Organize fontes, notas e pesquisas em espaços de trabalho focados.",
    newNotebook: "Novo Caderno",
    searchPlaceholder: "Buscar cadernos...",
    sortLabel: "Ordenar cadernos",
    sortDirection: "Alterar direção da ordenação",
    archived: "Arquivado",
    archive: "Arquivar",
    unarchive: "Desarquivar",
    archiveConfirmTitle: "Arquivar caderno?",
    archiveConfirmDescription: "Tem certeza de que deseja arquivar \"{{name}}\"? Você poderá restaurá-lo depois em Cadernos arquivados.",
    unarchiveConfirmTitle: "Desarquivar caderno?",
    unarchiveConfirmDescription: "Tem certeza de que deseja mover \"{{name}}\" de volta para Cadernos ativos?",
  ...
  sources: {
    ...
    selectMultipleFilesHint: "Selecione múltiplos arquivos para importação em lote. Documentos suportados: PDF, DOC, DOCX, PPT, XLS, EPUB, TXT, MD.",
    mediaUnavailable: "Uploads de áudio e vídeo indisponíveis - FFmpeg não está instalado no servidor.",
    imagesUnavailable: "Extração de imagens indisponível - Docling não está instalado no servidor.",
    uploadDropzoneLabel: "Área de upload de arquivos",
    uploadDropzoneCta: "Arraste arquivos aqui, ou clique para navegar",
    uploadRejectedFiles: "{{count}} arquivo(s) não suportado(s) ignorado(s): {{files}}",
    ...
    librarySearchLabel: "Pesquisar fontes",
    librarySearchPlaceholder: "Pesquisar títulos de fontes...",
    sortLabel: "Ordenar fontes",
    sortDirection: "Alterar direção da ordenação",
    loadMore: "Carregar mais fontes",
    cleanupStarted: "Cleanup started",
    cleanupStartedDesc: "The worker is deleting eligible originals. Extracted content is preserved.",
    originalDeleted: "Original file deleted",
    originalDeletedDesc: "Extracted content, insights, and notebook links are unchanged.",
    ...
    deleteOriginalConfirmTitle: "Delete original file?",
    deleteOriginalConfirmDesc: "The uploaded file will be permanently removed. Extracted content, insights, and notebook links are preserved.",
    originalStatusRetained: "retained",
    originalStatusDeleted: "deleted",
    originalStatusMissing: "missing",
  ...
  searchPage: {
    askAndSearch: "Perguntar e Buscar",
    askAndSearchDesc: "Faça perguntas ou pesquise na sua base de conhecimento.",
    ...
    askNeedsEmbedding: "Ask precisa de um modelo de embedding",
    askNeedsEmbeddingDesc: "Defina um modelo de embedding para o Ask usar suas fontes.",
    askNeedsChat: "Ask precisa de um modelo de chat",
    askNeedsChatDesc: "Defina um modelo de chat antes de fazer uma pergunta.",
    advanced: "Avançado",
    strategy: "Estratégia",
    answer: "Resposta",
    final: "Final",
    ...
    vectorSearchOff: "A busca vetorial está desativada",
    vectorSearchOffDesc: "Defina um modelo de embedding para buscar por significado. A busca por texto continua disponível.",
    setUpModels: "Configurar modelos",
  ...
  podcasts: {
    ...
    commonDetailsTab: "Detalhes gerais",
    briefing: "Briefing",
    noOutline: "Nenhum outline disponível.",
    noTranscript: "Nenhuma transcrição disponível.",
    episodeNotFound: "Episódio não encontrado",
    episodeNotFoundDesc: "O episódio solicitado não existe.",
    backToPodcasts: "Voltar para podcasts",
  ...
  settings: {
    ...
    originalFilePolicy: "Original File Policy",
    originalFilePolicyDesc: "Controls what happens to the original uploaded file after processing. Applies to new uploads only. · Always keep: retain every original after processing succeeds — the owner has no per-upload choice. · Let user choose: each upload lets its owner pick keep or delete; the Default upload action below decides when the owner does not specify. · Always delete after processing: every original is deleted the moment processing completes successfully. Failures always retain the file for retry.",
    originalFilePolicyAlwaysKeep: "Always keep",
    originalFilePolicyUserChoice: "Let user choose",
    originalFilePolicyAlwaysDelete: "Always delete after processing",
    originalFileDefault: "Default upload action",
    originalFileDefaultDesc: "Used when the source owner does not choose.",
    originalFileDefaultKeep: "Keep original",
    originalFileDefaultDelete: "Delete after processing",
    allowOwnerCleanup: "Allow source owners to clean up own files",
    allowOwnerCleanupDesc: "Lets source owners delete retained original files they own — from Source Details on their own uploads. · Off: only administrators can delete retained originals. · On: owners see a Delete original button on their own retained files. Editors and viewers are never granted delete rights.",
    fileRetentionFuture: "Policy changes apply to future uploads only; existing sources are not modified.",
    cleanupAllUsers: "Delete retained original files (all users)",
    cleanupAllUsersDesc: "Includes files uploaded by all users, including the administrator. Extracted content, insights, and notebook links are preserved.",
    cleanupPreview: "{{count}} eligible file(s), {{size}} total",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Uma nova versão de {{appName}} está disponível.",
    upToDate: "Atualizado",
    unknown: "Desconhecido",
  ...
  transformations: {
    ...
    createTransformation: "Criar transformação",
    createSheetDescription: "Crie um prompt reutilizável que transforme o conteúdo da fonte em resumos, insights ou resultados estruturados.",
    editSheetDescription: "Atualize o prompt, o modelo e as configurações padrão que controlam como o conteúdo da fonte é transformado.",
    ...
    restoreSuccess: "Transformation restored successfully",
    restore: "Restore",
    builtin: "Built-in",
    personal: "Personal",
    archived: "Archived",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure quais modelos usar para diferentes propósitos na aplicação {{appName}}",
    missingRequiredModels: "Modelos obrigatórios ausentes: {{models}}. A aplicação {{appName}} pode não funcionar corretamente sem eles.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Importar documentos do SharePoint",
    unavailable: "O conector do SharePoint não está configurado. Peça a um administrador para ativá-lo.",
    requestFailed: "A solicitação ao SharePoint falhou. Tente novamente.",
    connect: "Conectar ao SharePoint",
    connectDescription: "Conecte sua conta Microsoft para procurar documentos do SharePoint.",
    empty: "Nada encontrado aqui.",
    folderHint: "Esta pasta e seus documentos compatíveis serão importados.",
    importFolder: "Importar esta pasta",
    location: "Local do SharePoint",
    partial: "Concluído parcialmente",
    pending: "Pendente",
    processingHint: "Os documentos importados ainda podem estar em processamento após a conclusão deste lote.",
    progress: "{{completed}} de {{total}} concluídos; {{failed}} com falha",
    queued: "Na fila",
    searchSites: "Pesquisar sites",
    selectAll: "Selecionar todos os arquivos compatíveis nesta página",
    ...
    connectionsDescription: "Conecte as contas usadas para importar documentos.",
    cardDescription: "Importe copias dos documentos que voce pode ler. Os arquivos no SharePoint permanecem inalterados.",
    connected: "Conectado",
    notConnected: "Nao conectado",
    needsReconnect: "Precisa reconectar",
    manageConnection: "Gerenciar conexao",
    disconnectMicrosoft: "A Microsoft pode continuar listando este aplicativo ate voce remove-lo em Meus aplicativos.",
    unavailableStatus: "Indisponivel",
