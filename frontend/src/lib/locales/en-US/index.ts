export const enUS = {
  ...
  settings: {
    ...
    filesHelp: "Once your files are uploaded and processed, they are not required anymore. Most users should allow {{appName}} to delete uploaded files from the upload folder automatically.",
