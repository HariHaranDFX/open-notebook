...
export const esES = {
  ...
  settings: {
    ...
    originalFilePolicyDesc: "Cómo se conservan los archivos originales tras el procesamiento. Solo se aplica a nuevas cargas.",
    ...
    allowOwnerCleanupDesc: "Cuando se activa, los propietarios pueden eliminar sus originales conservados. Nunca concede este permiso a editores o lectores.",
