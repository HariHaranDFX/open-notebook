...
export const zhTW = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "您無權存取此內容",
      forbiddenDescription: "該內容僅以唯讀方式共用，或您已不再擁有開啟它的權限。",
    },
    accessibility: {
    ...
    contextSummary: {
      label: "上下文",
      empty: "上下文中未包含任何來源或筆記。",
      tokens: "{{value}} 個詞元",
      characters: "{{value}} 個字元",
    },
    clickToEdit: "點擊編輯",
  },
  workbench: {
  ...
  groups: {
    ...
    syncEntra: "立即同步",
    syncedFromEntra: "已從 Entra 同步",
    linkedFromEntra: "從 Entra 連結",
    searchEntraGroups: "搜尋 Entra 群組",
    searchEntraPlaceholder: "輸入以搜尋你的 Entra 目錄…",
    noEntraResults: "沒有相符的 Entra 群組",
  ...
  notebooks: {
    title: "筆記本",
    description: "在專注的工作區中整理來源、筆記和研究。",
    newNotebook: "新增筆記本",
    searchPlaceholder: "搜尋筆記本...",
    sortLabel: "筆記本排序",
    sortDirection: "變更排序方向",
    archived: "已封存",
    archive: "封存",
    unarchive: "取消封存",
    archiveConfirmTitle: "封存筆記本？",
    archiveConfirmDescription: "確定要封存「{{name}}」嗎？之後可從已封存筆記本中還原。",
    unarchiveConfirmTitle: "取消封存筆記本？",
    unarchiveConfirmDescription: "確定要將「{{name}}」移回使用中的筆記本嗎？",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "檔案上傳區域",
    uploadDropzoneCta: "將檔案拖到此處，或點擊瀏覽",
    uploadRejectedFiles: "已略過 {{count}} 個不支援的檔案：{{files}}",
    selectedFiles: "已選擇檔案：",
    ...
    librarySearchLabel: "搜尋來源",
    librarySearchPlaceholder: "搜尋來源標題...",
    sortLabel: "來源排序",
    sortDirection: "變更排序方向",
    loadMore: "載入更多來源",
  ...
  searchPage: {
    ...
    askNeedsEmbedding: "提問需要嵌入模型",
    askNeedsEmbeddingDesc: "設定嵌入模型後，提問才能使用你的資料。",
    askNeedsChat: "提問需要聊天模型",
    askNeedsChatDesc: "提問前請先設定聊天模型。",
    advanced: "進階",
    strategy: "策略",
    answer: "回答",
    final: "最終",
    ...
    searchType: "搜尋類型",
    vectorSearchOff: "向量搜尋已關閉",
    vectorSearchOffDesc: "設定嵌入模型後即可依含義搜尋。文字搜尋仍然可用。",
    setUpModels: "設定模型",
    textSearch: "文本搜尋",
    vectorSearch: "向量搜尋",
    searchIn: "搜尋範圍",
  ...
  podcasts: {
    ...
    outlineTab: "大綱",
    transcriptTab: "腳本",
    commonDetailsTab: "一般詳細",
    briefing: "內容簡報",
    noOutline: "暫無大綱。",
    noTranscript: "暫無腳本。",
    episodeNotFound: "找不到劇集",
    episodeNotFoundDesc: "請求的劇集不存在。",
    backToPodcasts: "返回播客",
  ...
  transformations: {
    ...
    listTitle: "自訂轉換",
    createNew: "新建轉換",
    createTransformation: "建立轉換",
    createSheetDescription: "建立可重複使用的提示詞，將來源內容轉換為摘要、洞察或結構化輸出。",
    editSheetDescription: "更新控制來源內容轉換方式的提示詞、模型和預設設定。",
    inputLabel: "輸入文本",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "設定用於 {{appName}} 不同用途的預設模型",
    missingRequiredModels: "缺少必需的模型：{{models}}。如果没有這些模型，{{appName}} 可能無法正常運行。",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "從 SharePoint 匯入文件",
    unavailable: "尚未設定 SharePoint 連接器。請聯絡管理員啟用。",
    requestFailed: "SharePoint 要求失敗，請再試一次。",
    connect: "連接 SharePoint",
    connectDescription: "連接 Microsoft 帳戶以瀏覽 SharePoint 文件。",
    empty: "這裡找不到內容。",
    folderHint: "將匯入此資料夾及其中受支援的文件。",
    importFolder: "匯入此資料夾",
    location: "SharePoint 位置",
    partial: "部分完成",
    pending: "待處理",
    processingHint: "此批次完成後，匯入的文件可能仍在處理中。",
    progress: "已完成 {{completed}}/{{total}}；失敗 {{failed}}",
    queued: "已排入佇列",
    searchSites: "搜尋網站",
    selectAll: "選取此頁面所有受支援的檔案",
    ...
    connectionsDescription: "連接用來匯入文件的帳戶。",
    cardDescription: "匯入您可以閱讀的文件複本。SharePoint 中的檔案不會變更。",
    connected: "已連線",
    notConnected: "未連線",
    needsReconnect: "需要重新連線",
    manageConnection: "管理連線",
    disconnectMicrosoft: "在您於「我的應用程式」中移除之前，Microsoft 可能仍會列出此應用程式。",
