export const enUS = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "You don't have access to this content",
      forbiddenDescription: "It's shared as view-only, or you no longer have permission to open it.",
    },
    accessibility: {
    ...
    contextModes: {
      ...
      noteLabel: "Note context",
    },
    contextSummary: {
      label: "Context",
      empty: "No sources or notes are included in context.",
      tokens: "{{value}} tokens",
  ...
  connectionErrors: {
    ...
    apiDesc: "The {{appName}} API server could not be reached",
  ...
  sharing: {
    share: "Share",
    title: "Share",
    description: "Manage who can access this",
    grants: "People with access",
    noGrants: "Not shared yet",
    add: "Add",
    user: "User",
    group: "Group",
    viewer: "Viewer",
  ...
  notebooks: {
    title: "Notebooks",
    description: "Organize sources, notes, and research in focused workspaces.",
    newNotebook: "New Notebook",
    ...
    archive: "Archive",
    unarchive: "Unarchive",
    archiveConfirmTitle: "Archive notebook?",
    archiveConfirmDescription: "Are you sure you want to archive \"{{name}}\"? You can restore it later from Archived Notebooks.",
    unarchiveConfirmTitle: "Unarchive notebook?",
    unarchiveConfirmDescription: "Are you sure you want to move \"{{name}}\" back to Active Notebooks?",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "File upload area",
    uploadDropzoneCta: "Drag files here, or click to browse",
    uploadRejectedFiles: "Skipped {{count}} unsupported file(s): {{files}}",
    ...
    librarySearchLabel: "Search sources",
    librarySearchPlaceholder: "Search source titles...",
    sortLabel: "Sort sources",
    sortDirection: "Change sort direction",
  ...
  searchPage: {
    askAndSearch: "Ask and Search",
    askAndSearchDesc: "Ask questions or search your knowledge base.",
    askBeta: "Ask (beta)",
    search: "Search",
    ...
    askNeedsEmbedding: "Ask needs an embedding model",
    askNeedsEmbeddingDesc: "Set an embedding model so Ask can use your sources.",
    askNeedsChat: "Ask needs a chat model",
    askNeedsChatDesc: "Set a chat model before asking a question.",
    advanced: "Advanced",
    strategy: "Strategy",
    answer: "Answer",
    final: "Final",
    ...
    vectorSearchOff: "Vector search is off",
    vectorSearchOffDesc: "Set an embedding model to search by meaning. Text search still works.",
    ...
    scopeClear: "Clear",
    scopeHint: "Leave empty to search the whole knowledge base.",
    scopeNoNotebooks: "No notebooks available.",
  ...
  podcasts: {
    ...
    commonDetailsTab: "Common Details",
    briefing: "Briefing",
    noOutline: "No outline available.",
    noTranscript: "No transcript available.",
    episodeNotFound: "Episode not found",
    episodeNotFoundDesc: "The requested episode does not exist.",
  ...
  advanced: {
    ...
    updateAvailableDesc: "A new version of {{appName}} is available.",
    upToDate: "Up to Date",
    unknown: "Unknown",
  ...
  transformations: {
    ...
    createSheetDescription: "Create a reusable prompt that turns source content into summaries, insights, or structured output.",
    editSheetDescription: "Update the prompt, model, and defaults that control how source content is transformed.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Configure which models to use for different purposes across {{appName}}",
    missingRequiredModels: "Missing required models: {{models}}. {{appName}} may not function properly without these.",
  ...
  apiKeys: {
    ...
    apiVersionHint: "Required for Azure OpenAI (e.g. 2024-10-21). Use the version your Azure resource supports.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Import documents from SharePoint",
    unavailable: "SharePoint connector is not configured. Ask an administrator to enable it.",
    requestFailed: "SharePoint request failed. Please try again.",
    connect: "Connect SharePoint",
    connectDescription: "Connect your Microsoft account to browse SharePoint documents.",
    empty: "Nothing found here.",
    folderHint: "This folder and its supported documents will be imported.",
    importFolder: "Import this folder",
    location: "SharePoint location",
    partial: "Partially completed",
    pending: "Pending",
    processingHint: "Imported documents may still be processing after this batch completes.",
    progress: "{{completed}} of {{total}} completed; {{failed}} failed",
    queued: "Queued",
    searchSites: "Search sites",
    selectAll: "Select all supported files on this page",
    ...
    connectionsDescription: "Connect the accounts used to import documents.",
    cardDescription: "Import copies of documents you can read. Files in SharePoint stay unchanged.",
    connected: "Connected",
    notConnected: "Not connected",
    needsReconnect: "Needs reconnect",
    manageConnection: "Manage connection",
    disconnectMicrosoft: "Microsoft may still list this app until you remove it in My Apps.",
