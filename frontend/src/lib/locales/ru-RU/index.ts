...
export const ruRU = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "У вас нет доступа к этому контенту",
      forbiddenDescription: "Он доступен только для чтения, или у вас больше нет разрешения на его открытие.",
    },
    accessibility: {
      ...
      settingsNav: "Навигация по настройкам",
    },
    url: "URL",
    ...
    contextModes: {
      ...
      full: "Полный источник",
      included: "Включено",
      sourceLabel: "Контекст источника",
      noteLabel: "Контекст заметки",
    },
    contextSummary: {
      label: "Контекст",
      empty: "В контекст не включены источники или заметки.",
      tokens: "{{value}} токенов",
      characters: "{{value}} символов",
    },
  ...
  apiErrors: {
    ...
    entraPermissionDenied: "Microsoft Graph отклонил запрос. Попросите администратора тенанта предоставить подключённому приложению требуемое разрешение и подтвердить согласие администратора — необходимы оба действия.",
  ...
  connectionErrors: {
    ...
    apiDesc: "API-сервер {{appName}} недоступен",
  ...
  sharing: {
    ...
    grants: "У кого есть доступ",
    noGrants: "Ещё не расшарено",
    add: "Добавить",
    user: "Пользователь",
    group: "Группа",
    viewer: "Читатель",
    ...
    grantAdded: "Доступ предоставлен",
  ...
  groups: {
    ...
    syncedFromEntra: "Синхронизировано из Entra",
    linkedFromEntra: "Связано из Entra",
    searchEntraGroups: "Поиск групп Entra",
    searchEntraPlaceholder: "Введите текст для поиска в каталоге Entra…",
    noEntraResults: "Нет подходящих групп Entra",
  ...
  notebooks: {
    title: "Блокноты",
    description: "Организуйте источники, заметки и исследования в тематических рабочих пространствах.",
    newNotebook: "Новый блокнот",
    searchPlaceholder: "Поиск блокнотов...",
    sortLabel: "Сортировать блокноты",
    sortDirection: "Изменить направление сортировки",
    archived: "Архивные",
    archive: "Архивировать",
    unarchive: "Разархивировать",
    archiveConfirmTitle: "Архивировать блокнот?",
    archiveConfirmDescription: "Вы уверены, что хотите архивировать «{{name}}»? Позже его можно восстановить из архивных блокнотов.",
    unarchiveConfirmTitle: "Разархивировать блокнот?",
    unarchiveConfirmDescription: "Вы уверены, что хотите вернуть «{{name}}» в активные блокноты?",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "Область загрузки файлов",
    uploadDropzoneCta: "Перетащите файлы сюда или щёлкните для выбора",
    uploadRejectedFiles: "Пропущено {{count}} неподдерживаемых файл(а): {{files}}",
    ...
    librarySearchLabel: "Поиск источников",
    librarySearchPlaceholder: "Искать по заголовкам...",
    sortLabel: "Сортировать источники",
    sortDirection: "Изменить направление сортировки",
    loadMore: "Загрузить ещё источники",
    ...
    statusPartial: "Доступно частично",
  ...
  searchPage: {
    askAndSearch: "Запрос и поиск",
    askAndSearchDesc: "Задавайте вопросы или ищите в базе знаний.",
    askBeta: "Запрос (бета)",
    search: "Поиск",
    ...
    askNeedsEmbedding: "Для вопроса нужна модель эмбеддинга",
    askNeedsEmbeddingDesc: "Задайте модель эмбеддинга, чтобы вопрос мог использовать ваши источники.",
    askNeedsChat: "Для вопроса нужна модель чата",
    askNeedsChatDesc: "Задайте модель чата, прежде чем задавать вопрос.",
    ...
    vectorSearchOff: "Векторный поиск выключен",
    vectorSearchOffDesc: "Задайте модель эмбеддинга, чтобы искать по смыслу. Текстовый поиск по-прежнему работает.",
    setUpModels: "Настроить модели",
  ...
  podcasts: {
    ...
    loadMore: "Загрузить ещё эпизоды",
    ...
    commonDetailsTab: "Общие сведения",
    briefing: "Брифинг",
    noOutline: "План недоступен.",
    noTranscript: "Транскрипт недоступен.",
    episodeNotFound: "Эпизод не найден",
    episodeNotFoundDesc: "Запрошенный эпизод не существует.",
    backToPodcasts: "Вернуться к подкастам",
  ...
  advanced: {
    ...
    updateAvailableDesc: "Доступна новая версия {{appName}}.",
  ...
  transformations: {
    clear: "Очистить",
    copy: "Копировать",
    outputPlaceholder: "Запустите тест, чтобы увидеть результат здесь",
    runError: "Не удалось выполнить преобразование. Проверьте настройку модели и повторите попытку.",
    title: "Трансформации",
    ...
    createTransformation: "Создать трансформацию",
    createSheetDescription: "Создайте многоразовый промпт, который преобразует содержимое источника в резюме, выводы или структурированный результат.",
    editSheetDescription: "Обновите промпт, модель и настройки по умолчанию, определяющие преобразование содержимого источника.",
    ...
    testInPlayground: "Протестировать в песочнице",
    notFound: "Трансформация не найдена",
    notFoundDesc: "Возможно, эта трансформация была удалена или больше недоступна.",
  ...
  models: {
    ...
    defaultAssignmentsDesc: "Настройте, какие модели использовать для различных задач в {{appName}}",
    missingRequiredModels: "Отсутствуют необходимые модели: {{models}}. {{appName}} может работать некорректно без них.",
  ...
  apiKeys: {
    ...
    apiVersionHint: "Обязательно для Azure OpenAI (например, 2024-10-21). Укажите версию, поддерживаемую вашим ресурсом Azure.",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "Импорт документов из SharePoint",
    unavailable: "Подключение SharePoint не настроено. Попросите администратора включить его.",
    requestFailed: "Не удалось выполнить запрос SharePoint. Повторите попытку.",
    connect: "Подключить SharePoint",
    connectDescription: "Подключите учётную запись Microsoft для просмотра документов SharePoint.",
    empty: "Здесь ничего не найдено.",
    folderHint: "Эта папка и поддерживаемые документы в ней будут импортированы.",
    importFolder: "Импортировать эту папку",
    location: "Расположение в SharePoint",
    partial: "Частично завершено",
    pending: "Ожидает",
    processingHint: "Импортированные документы могут обрабатываться и после завершения этой партии.",
    progress: "Завершено: {{completed}} из {{total}}; ошибок: {{failed}}",
    queued: "В очереди",
    searchSites: "Поиск сайтов",
    selectAll: "Выбрать все поддерживаемые файлы на этой странице",
    ...
    connectionsDescription: "Подключите учетные записи для импорта документов.",
    cardDescription: "Импортируйте копии документов, которые вы можете читать. Файлы в SharePoint не изменяются.",
    connected: "Подключено",
    notConnected: "Не подключено",
    needsReconnect: "Нужно переподключить",
    manageConnection: "Управление подключением",
    disconnectMicrosoft: "Microsoft может по-прежнему показывать это приложение, пока вы не удалите его в «Мои приложения».",
