...
export const bnIN = {
  ...
  common: {
    ...
    contentUnavailable: {
      ...
      forbiddenTitle: "এই কন্টেন্টে আপনার অ্যাক্সেস নেই",
      forbiddenDescription: "এটি শুধুমাত্র দেখার জন্য শেয়ার করা হয়েছে, অথবা এটি খোলার অনুমতি আপনার আর নেই।",
    },
    accessibility: {
    ...
    contextModes: {
        off: "বাদ দেওয়া হয়েছে",
        insights: "শুধুমাত্র অন্তর্দৃষ্টি",
        full: "সম্পূর্ণ উৎস",
        included: "অন্তর্ভুক্ত",
        sourceLabel: "উৎস প্রসঙ্গ",
        noteLabel: "নোট প্রসঙ্গ",
    },
    contextSummary: {
        label: "প্রসঙ্গ",
        empty: "প্রসঙ্গে কোনো উৎস বা নোট অন্তর্ভুক্ত নেই।",
        tokens: "{{value}} টোকেন",
        characters: "{{value}} অক্ষর",
    },
  ...
  apiErrors: {
    ...
    entraCredentialInvalid: "সংযুক্ত Entra অ্যাপের ক্রেডেনশিয়াল অবৈধ বা মেয়াদোত্তীর্ণ। অপারেটরকে সেগুলি রিফ্রেশ করতে বলুন।",
    entraPermissionDenied: "Microsoft Graph অনুরোধটি প্রত্যাখ্যান করেছে। টেন্যান্ট প্রশাসককে সংযুক্ত অ্যাপে প্রয়োজনীয় অনুমতি প্রদান করতে এবং অ্যাডমিন সম্মতি নিশ্চিত করতে বলুন — উভয়ই প্রয়োজন।",
    entraGraphUpstream: "Microsoft Graph-এ পৌঁছানো যাচ্ছে না বা একটি ত্রুটি ফিরিয়ে দিয়েছে। কিছুক্ষণ পরে আবার চেষ্টা করুন।",
    entraSyncDisabled: "এই ডিপ্লয়মেন্টে Entra গ্রুপ সিঙ্ক সক্ষম নয়। ম্যানুয়াল সিঙ্ক চালানোর আগে অপারেটরকে এটি সক্ষম করতে বলুন।",
  },
  connectionErrors: {
  ...
  sharing: {
    share: "শেয়ার",
    title: "শেয়ার",
    description: "কে অ্যাক্সেস করতে পারবে তা পরিচালনা করুন",
    grants: "অ্যাক্সেস আছে যাদের",
    noGrants: "এখনও শেয়ার করা হয়নি",
    add: "যোগ",
    user: "ব্যবহারকারী",
    group: "গ্রুপ",
    viewer: "দর্শক",
    ...
    grantAdded: "অ্যাক্সেস দেওয়া হয়েছে",
  ...
  groups: {
    ...
    createSuccess: "গ্রুপ তৈরি হয়েছে",
    ...
    syncedFromEntra: "Entra থেকে সিঙ্ক করা",
    linkedFromEntra: "Entra থেকে লিঙ্ক করা",
    searchEntraGroups: "Entra গ্রুপ খুঁজুন",
    searchEntraPlaceholder: "আপনার Entra ডিরেক্টরি খুঁজতে টাইপ করুন…",
    noEntraResults: "মিলে যাওয়া Entra গ্রুপ নেই",
  ...
  notebooks: {
    title: "নোটবুকগুলি",
    description: "উৎস, নোট এবং গবেষণা কেন্দ্রীভূত কর্মক্ষেত্রে সংগঠিত করুন।",
    newNotebook: "নতুন নোটবুক",
    searchPlaceholder: "নোটবুক অনুসন্ধান...",
    sortLabel: "নোটবুক সাজান",
    sortDirection: "সাজানোর দিক পরিবর্তন করুন",
    archived: "আর্কাইভ করা",
    archive: "আর্কাইভ",
    unarchive: "আর্কাইভ বাতিল",
    archiveConfirmTitle: "নোটবুক আর্কাইভ করবেন?",
    archiveConfirmDescription: "আপনি কি নিশ্চিত যে \"{{name}}\" আর্কাইভ করতে চান? পরে আর্কাইভ করা নোটবুক থেকে এটি পুনরুদ্ধার করতে পারবেন।",
    unarchiveConfirmTitle: "নোটবুক আর্কাইভমুক্ত করবেন?",
    unarchiveConfirmDescription: "আপনি কি নিশ্চিত যে \"{{name}}\" আবার সক্রিয় নোটবুকে নিতে চান?",
  ...
  sources: {
    ...
    uploadDropzoneLabel: "ফাইল আপলোড এলাকা",
    uploadDropzoneCta: "ফাইল এখানে টেনে আনুন, বা ব্রাউজ করতে ক্লিক করুন",
    uploadRejectedFiles: "{{count}}টি অসমর্থিত ফাইল বাদ দেওয়া হয়েছে: {{files}}",
    ...
    librarySearchLabel: "উৎস খুঁজুন",
    librarySearchPlaceholder: "উৎসের শিরোনাম খুঁজুন...",
    sortLabel: "উৎস সাজান",
    sortDirection: "সাজানোর দিক পরিবর্তন করুন",
    loadMore: "আরও উৎস লোড করুন",
    ...
    statusPartial: "আংশিকভাবে উপলব্ধ",
    statusUnavailable: "স্থিতি উপলব্ধ নয়",
    accessRole: "অ্যাক্সেস",
  ...
  searchPage: {
    askAndSearch: "জিজ্ঞাসা ও অনুসন্ধান",
    askAndSearchDesc: "প্রশ্ন করুন বা আপনার নলেজ বেসে অনুসন্ধান করুন।",
    ...
    askNeedsEmbedding: "Ask-এর একটি এমবেডিং মডেল দরকার",
    askNeedsEmbeddingDesc: "Ask যাতে আপনার উৎস ব্যবহার করতে পারে, একটি এমবেডিং মডেল সেট করুন।",
    askNeedsChat: "Ask-এর একটি চ্যাট মডেল দরকার",
    askNeedsChatDesc: "প্রশ্ন করার আগে একটি চ্যাট মডেল সেট করুন।",
    advanced: "উন্নত",
    strategy: "কৌশল",
    answer: "উত্তর",
    final: "চূড়ান্ত",
    ...
    vectorSearchOff: "ভেক্টর অনুসন্ধান বন্ধ",
    vectorSearchOffDesc: "অর্থ অনুসারে খুঁজতে একটি এমবেডিং মডেল সেট করুন। টেক্সট অনুসন্ধান চালু থাকে।",
    setUpModels: "মডেল সেট করুন",
  ...
  podcasts: {
    ...
    commonDetailsTab: "সাধারণ বিবরণ",
    briefing: "ব্রিফিং",
    noOutline: "কোন রূপরেখা উপলব্ধ নয়।",
    noTranscript: "কোন ট্রান্সক্রিপ্ট উপলব্ধ নয়।",
    episodeNotFound: "এপিসোড পাওয়া যায়নি",
    episodeNotFoundDesc: "অনুরোধকৃত এপিসোডটি বিদ্যমান নেই।",
    backToPodcasts: "পডকাস্টে ফিরে যান",
  ...
  advanced: {
    ...
    updateAvailableDesc: "{{appName}} এর একটি নতুন সংস্করণ উপলব্ধ।",
    upToDate: "আপ টু ডেট",
    unknown: "অজানা",
  ...
  transformations: {
    ...
    createTransformation: "ট্রান্সফরমেশন তৈরি করুন",
    createSheetDescription: "উৎসের কনটেন্টকে সারাংশ, অন্তর্দৃষ্টি বা কাঠামোবদ্ধ আউটপুটে রূপান্তর করার জন্য পুনর্ব্যবহারযোগ্য প্রম্পট তৈরি করুন।",
    editSheetDescription: "উৎসের কনটেন্ট কীভাবে রূপান্তরিত হবে তা নিয়ন্ত্রণকারী প্রম্পট, মডেল এবং ডিফল্ট সেটিংস আপডেট করুন।",
    ...
    testInPlayground: "প্লেগ্রাউন্ডে পরীক্ষা করুন",
    notFound: "ট্রান্সফরমেশন পাওয়া যায়নি",
    notFoundDesc: "এই ট্রান্সফরমেশনটি মুছে ফেলা হয়ে থাকতে পারে বা আর উপলব্ধ নেই।",
  ...
  apiKeys: {
    ...
    apiVersion: "API সংস্করণ",
    apiVersionHint: "Azure OpenAI-এর জন্য আবশ্যক (যেমন 2024-10-21)। আপনার Azure রিসোর্স যে সংস্করণ সমর্থন করে তা ব্যবহার করুন।",
  ...
  sharepoint: {
    title: "SharePoint",
    description: "SharePoint থেকে নথি আমদানি করুন",
    unavailable: "SharePoint সংযোগকারী কনফিগার করা নেই। এটি চালু করতে প্রশাসককে বলুন।",
    requestFailed: "SharePoint অনুরোধ ব্যর্থ হয়েছে। আবার চেষ্টা করুন।",
    connect: "SharePoint সংযুক্ত করুন",
    connectDescription: "SharePoint নথি দেখতে আপনার Microsoft অ্যাকাউন্ট সংযুক্ত করুন।",
    empty: "এখানে কিছু পাওয়া যায়নি।",
    folderHint: "এই ফোল্ডার এবং এর সমর্থিত নথিগুলি আমদানি করা হবে।",
    importFolder: "এই ফোল্ডার আমদানি করুন",
    location: "SharePoint অবস্থান",
    partial: "আংশিক সম্পন্ন",
    pending: "অপেক্ষমাণ",
    processingHint: "এই ব্যাচ শেষ হওয়ার পরেও আমদানি করা নথিগুলির প্রক্রিয়াকরণ চলতে পারে।",
    progress: "{{total}}টির মধ্যে {{completed}}টি সম্পন্ন; {{failed}}টি ব্যর্থ",
    queued: "সারিতে আছে",
    searchSites: "সাইট খুঁজুন",
    selectAll: "এই পৃষ্ঠার সব সমর্থিত ফাইল নির্বাচন করুন",
    selected: "{{count}}টি ফাইল নির্বাচিত",
    sites: "সাইট",
    ...
    connectionsDescription: "নথি আমদানিতে ব্যবহৃত অ্যাকাউন্ট সংযুক্ত করুন।",
    cardDescription: "আপনি যে নথি পড়তে পারেন তার অনুলিপি আমদানি করুন। SharePoint-এর ফাইল অপরিবর্তিত থাকে।",
    connected: "সংযুক্ত",
    notConnected: "সংযুক্ত নয়",
    needsReconnect: "পুনরায় সংযোগ দরকার",
    manageConnection: "সংযোগ পরিচালনা",
    disconnectMicrosoft: "আমার অ্যাপ থেকে সরানোর আগে Microsoft এই অ্যাপটি তালিকায় রাখতে পারে।",
    unavailableStatus: "অনুপলব্ধ",
