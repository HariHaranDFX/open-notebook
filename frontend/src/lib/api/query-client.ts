...
export const QUERY_KEYS = {
  ...
  notebookLibrary: (params: {
    archived: boolean
    query: string
    sortBy: string
    sortOrder: string
  }) => ['notebooks', 'library', params] as const,
  ...
  podcastEpisodeLibrary: (params: {
    query: string
    sortBy: string
    sortOrder: string
  }) => ['podcasts', 'episodes', 'library', params] as const,
  podcastEpisodeSummary: ['podcasts', 'episodes', 'summary'] as const,
