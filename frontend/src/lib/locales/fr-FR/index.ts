...
export const frFR = {
  ...
  settings: {
    ...
    filesHelp: "Une fois vos fichiers téléchargés et traités, ils ne sont plus nécessaires. La plupart des utilisateurs devraient autoriser {{appName}} à supprimer automatiquement les fichiers du dossier de téléchargement.",
